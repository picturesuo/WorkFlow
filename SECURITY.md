...
Chat stores Bedrock and OpenAI-compatible bearer tokens in separate macOS Keychain items and never intentionally writes them to logs, preferences, recordings, exports, or the repository. A report that shows otherwise is high priority.
